...
- Revalidación iteración fase 12 (2026-03-05):
  ...
  - se registra regresión de rollout como `PUM-015` y queda foco activo hasta alinear versión.
- foco activo actual: `PUM-015` (`🚧 En construccion`, issue `#725`).
