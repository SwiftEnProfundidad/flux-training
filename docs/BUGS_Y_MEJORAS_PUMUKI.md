...
- `PUM-010` queda como foco activo (`🚧 En construccion`) con seguimiento upstream:
  - issue: `https://github.com/SwiftEnProfundidad/ast-intelligence-hooks/issues/719`
  - objetivo: persistencia automática de bundles/rules de skills coverage entre iteraciones sin bootstrap manual repetido.
