...
- `FLUX_EXECUTION_TRACKING_V7.md`: ciclo activo de ejecucion V7 (tracking contract, hardening billing por proveedor y gobernanza operativa).
- `FLUX_EXECUTION_TRACKING_V8.md`: ciclo activo de escalado V8 (retention scaling, billing anomaly intelligence, support/governance automation).
...
- Estado activo actual: `FLUX_EXECUTION_TRACKING_V8.md` en `🚧` (task activa `V8-P0-T3`).
