...
- Empieza por [`./SEGUIMIENTO_MASTER.md`](./SEGUIMIENTO_MASTER.md).

## Fuente canónica de seguimiento
- [`./SEGUIMIENTO_MASTER.md`](./SEGUIMIENTO_MASTER.md): estado global, foco actual y resumen ejecutivo del proyecto.

## Documentos de apoyo
- `PLAN_CICLO_2_MVP_FUNCIONAL.md`: plan activo simple del nuevo ciclo de producto real.
- `PLAN_IOS_MVP_OPERATIVO.md`: detalle de avance iOS.
- `PLAN_WEB_MVP_OPERATIVO.md`: detalle de avance Web.
