...
const translations: Record<AppLanguage, AppTranslations> = {
  es: {
    ...
    offlineSyncTitle: "Sin conexión + Sincronización",
    syncStatusLabel: "Sincronización",
    syncQueue: "Sincronizar cola",
    refreshQueue: "Refrescar cola",
    pendingActionsLabel: "Acciones pendientes",
    rejectedLastSyncLabel: "Rechazadas en última sincronización",
    ...
    observabilityFatalCrashesLabel: "Fallos fatales",
    observabilityCanonicalCoverageLabel: "Cobertura canonica",
    observabilityOperationalAlertsLabel: "Alertas operativas abiertas",
    observabilityRunbooksLabel: "Guías operativas activas",
    observabilityOnCallOwnerLabel: "Responsable on-call",
    readinessLabel: "Preparacion",
    authMetric: "Acceso",
    ...
    dashboardHomeTitle: "Panel principal",
    dashboardHomeStatusLabel: "Panel",
    ...
    dashboardHomeRefreshAction: "Refrescar panel",
    quickActionsTitle: "Acciones rapidas",
    quickActionsStatusLabel: "Acciones",
    quickActionsSummary: "Atajos para cargar bloques críticos del panel en un solo paso.",
    quickActionsRunAll: "Ejecutar acciones rapidas",
    alertCenterTitle: "Centro de alertas",
    alertCenterStatusLabel: "Alertas",
    alertCenterSummary: "Monitorea incidencias críticas, severidad y guías operativas activas.",
    alertCenterLoadAction: "Cargar alertas",
    alertCenterAuditAction: "Abrir auditoría",
    alertCenterOpenCountLabel: "Alertas abiertas",
    alertCenterHighSeverityLabel: "Severidad critica",
    alertCenterRunbooksLabel: "Guías activas",
    ...
    systemStatusSummary: "Resumen operativo de estado, versión, cola y matriz de roles.",
    systemStatusRuntimeLabel: "Estado",
    systemStatusReleaseLabel: "Versión",
    systemStatusRoleMatrixLabel: "Matriz de roles",
    systemStatusQueueLabel: "Cola pendiente",
    dashboardKpisTitle: "Indicadores clave",
    dashboardKpisStatusLabel: "Indicadores",
    dashboardKpisSummary: "Resumen compacto de cobertura operativa para seguimiento diario.",
    dashboardKpisRefreshAction: "Refrescar indicadores",
    readinessMonitorTitle: "Monitor de preparacion",
    readinessMonitorStatusLabel: "Preparacion",
    readinessMonitorSummary: "Estado diario de preparacion, acceso y cola activa.",
    readinessMonitorScoreLabel: "Puntuación",
    readinessMonitorRefreshAction: "Actualizar preparacion",
    alertsFullTitle: "Alertas completas",
    alertsFullStatusLabel: "Alertas",
    alertsFullSummary:
      "Vista extendida de alertas operativas con runbook asociado y trazabilidad temporal.",
    alertsFullRefreshAction: "Refrescar alertas",
    alertsFullAuditAction: "Ver auditoría",
    alertsFullNoAlerts: "No hay alertas abiertas para este dominio.",
    alertsFullCodeLabel: "Codigo",
    alertsFullRunbookLabel: "Guía operativa",
