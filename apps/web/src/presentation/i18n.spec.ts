...
describe("i18n", () => {
  it("uses spanish as base language", () => {
    ...
    expect(translate("quickActionsStatusLabel")).toBe("Acciones");
    expect(translate("alertsFullTitle")).toBe("Alertas completas");
    expect(translate("shortcutsTitle")).toBe("Atajos");
  ...
  it("exposes domain filter translations in spanish", () => {
    ...
    expect(translate("dashboardHomeRefreshAction")).toBe("Refrescar panel");
    ...
    expect(translate("alertCenterAuditAction")).toBe("Abrir auditoría");
    ...
    expect(translate("alertCenterRunbooksLabel")).toBe("Guías activas");
    ...
    expect(translate("systemStatusRuntimeLabel")).toBe("Estado");
    expect(translate("systemStatusReleaseLabel")).toBe("Versión");
    ...
    expect(translate("readinessMonitorScoreLabel")).toBe("Puntuación");
    expect(translate("readinessMonitorRefreshAction")).toBe("Actualizar preparacion");
    expect(translate("alertsFullTitle")).toBe("Alertas completas");
    expect(translate("alertsFullStatusLabel")).toBe("Alertas");
    expect(translate("alertsFullRefreshAction")).toBe("Refrescar alertas");
    expect(translate("alertsFullAuditAction")).toBe("Ver auditoría");
    ...
    expect(translate("alertsFullRunbookLabel")).toBe("Guía operativa");
    ...
    expect(translate("shortcutsTitle")).toBe("Atajos");
    expect(translate("shortcutsStatusLabel")).toBe("Atajos");
    expect(translate("shortcutsRunAction")).toBe("Ejecutar atajos");
    expect(translate("shortcutsRefreshAction")).toBe("Refrescar atajos");
    ...
    expect(translate("shortcutsNoItems")).toBe("No hay atajos disponibles para este dominio.");
    ...
    expect(translate("observabilityRunbooksLabel")).toBe("Guías operativas activas");
    expect(translate("observabilityOnCallOwnerLabel")).toBe("Responsable on-call");
