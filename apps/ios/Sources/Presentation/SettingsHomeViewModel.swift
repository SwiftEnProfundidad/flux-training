...
@MainActor
@Observable
public final class SettingsHomeViewModel {
  public var notificationsEnabled = true
  public var watchSyncEnabled = true
  public var calendarSyncEnabled = false
  ...
  public func refresh(userID: String) async {
    ...
    do {
      ...
      watchSyncEnabled = loadedSettings.watchSyncEnabled
      calendarSyncEnabled = loadedSettings.calendarSyncEnabled
      status = "loaded"
    } catch {
