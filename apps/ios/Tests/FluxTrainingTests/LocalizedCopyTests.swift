...
final class LocalizedCopyTests: XCTestCase {
  func test_spanishIsBaseLanguage() {
    ...
    XCTAssertEqual(copy.text(.offlineSyncTitle), "Sin conexión + Sincronización")
    XCTAssertEqual(copy.text(.rejectedLastSyncLabel), "Rechazadas en última sincronización")
    ...
    XCTAssertEqual(copy.humanStatus("Session Required"), "inicia sesion")
    XCTAssertEqual(copy.humanStatus("signed-in:apple"), "sesion iniciada apple")
  ...
  func test_englishTranslationsAreAvailable() {
    ...
    XCTAssertEqual(copy.humanStatus("Session Required"), "sign in to continue")
    XCTAssertEqual(copy.humanStatus("signed in:email"), "signed in email")
    XCTAssertNil(copy.authFeedback("signed_out"))
