...
final class TrainingRouteContractTests: XCTestCase {
  func test_routeIdentifiers_matchCanonicalValues() {
    ...
    XCTAssertEqual(TrainingRouteContract.sessionSummaryDarkRouteID, "training.route.sessionSummary")
    ...
    XCTAssertEqual(TrainingRouteContract.sessionSummaryLightRouteID, "training.route.sessionSummaryLight")
    ...
    XCTAssertEqual(TrainingRouteContract.sessionSummaryRouteID, "training.route.sessionSummary")
  ...
  func test_screenIdentifiers_matchCanonicalValues() {
    ...
    XCTAssertEqual(TrainingRouteContract.sessionSummaryDarkScreenID, "training.sessionSummary.screen")
    ...
    XCTAssertEqual(TrainingRouteContract.sessionSummaryLightScreenID, "training.sessionSummary.light.screen")
    ...
    XCTAssertEqual(TrainingRouteContract.sessionSummaryScreenID, "training.sessionSummary.screen")
